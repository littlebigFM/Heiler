        ...
        >
          <div className="flex flex-col items-center flex-1 justify-center">
            ...
            <p className="text-center text-[#4A5568] text-sm leading-relaxed max-w-xs mb-10">
              Enjoy up to ₦1,000 with your referral code when your people sign
              up with it.
            </p>
            ...
            <div
              onClick={handleCopy}
              className="w-full flex items-center justify-center border border-primary rounded-[5px] px-4 py-3.5 bg-white **:cursor-pointer hover:bg-[#F1F5F9] active:scale-[0.99] transition-all duration-200 group"
            >
              {/* Code display field */}
              ...
              >
                {copied ? (
                  <FiCheck className="w-5 h-5  animate-scaleIn" />
                ) : (
                  <FaCopy className=" text-[#10B981] w-5 h-5 transition-transform group-active:scale-90" />
                )}
              </button>
            </div>
          </div>
